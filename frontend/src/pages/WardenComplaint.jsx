...
const WardenComplaints = () => {
  ...
  const getComplaints = async (e) => {
    try {
      const response = await fetch("https://hostelmate-backend-5zcj.onrender.com/complaints", {
        method: "GET",
        headers: headers,
      });
  ...
  const handleApproval = async (id) => {
    try {
      const response = await fetch(`https://hostelmate-backend-5zcj.onrender.com/complaints/${id}`, {
        method: "POST",
        headers: headers,
      });
